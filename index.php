...
<head>
	...
	<title>The Wedding of samsul jihad purnama & nely alia lestary</title>
	...
	<meta name="author" content="Rehan & Maulidan" />
...
<div id="page">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
						<h1>Samsul Jihad Purnama & Nely Aulia Lestary</h1>
	...
	<div id="fh5co-header">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					<h1>Samsul Jihad Purnama & Neli Aulia Lestary</h1>
				...
				<div class="couple-half">
					...
					<div class="desc-bride">
						...
						<div id="social-media-molid">
							<ul class="fh5co-social-icons">
								<li><a target="_blank" href="https://github.com/maulidandev"><i class="icon-github-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.linkedin.com/in/maulidandev/"><i class="icon-linkedin-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.instagram.com/maulidannashuha/"><i class="icon-instagram-with-circle"></i></a></li>
								<li><a target="_blank" href="https://www.facebook.com/maulidannashuha"><i class="icon-facebook-with-circle"></i></a></li>
	...
	<div id="fh5co-testimonial" style="background: url('images/background/repeat-background/so-white.png'); background-repeat:repeat; border-top: 1px solid #f2f2f2">
		...
		<div class="container">
			...
			<div id="button-send" class="text-center animate-box">
				<a href="https://github.com/maulidandev/nikah-rehan-maulidan/issues/new/choose" target="_blank" class="btn btn-primary btn-sm">Kirim Ucapan</a><br>
			...
			<div class="row copyright animate-box">
				<div class="col-md-12 text-center">
					...
					<ul class="fh5co-social-icons">
						...
						<li><a target="_blank" href="https://github.com/maulidandev"><i class="icon-github"></i></a></li>
						<li><a target="_blank" href="https://www.linkedin.com/in/maulidandev/"><i class="icon-linkedin"></i></a></li>
					</ul>
					</p>
				</div>
			</div>
